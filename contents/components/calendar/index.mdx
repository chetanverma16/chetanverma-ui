---
title: Calendar
description: A calendar component made with framer motion and tailwind css.
---

## Preview

<Preview>
  <Calendar maxWidth="max-w-sm" />
</Preview>
...
<PropsTable
  props={[
    ...
    {
      name: "showSelectedDateInfo",
      type: "boolean",
      description: "Whether to show the selected date info.",
      required: false,
    },
    {
      name: "className",
    ...
    },
    {
      name: "maxWidth",
      type: "string",
      description: "The max width of the calendar.",
      required: false,
    },
  ]}
/>
