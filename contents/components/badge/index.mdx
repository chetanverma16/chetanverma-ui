---
  title: Badge
  description: A customizable badge component with various styles and animations.
---
...
<PropsTable
  props={[
    ...
    },
    {
      name: "onClick",
      type: "() => void",
      description: "The onClick event of the badge.",
      required: false,
    },
    {
      name: "removable",
    ...
    },
    {
      name: "className",
      type: "string",
      description: "The className of the badge.",
      required: false,
    },
    {
      name: "maxWidth",
      type: "string | number",
      description: "The max width of the badge.",
      required: false,
    },
...

    {
      name: "onRemove",
      type: "() => void",
      description: "The onRemove event of the badge.",
      required: false,
    },

    {
      name: "isLoading",
      type: "boolean",
      description: "Whether the badge is loading.",
      required: false,
    },
