...
description: Input with tags component made with framer motion and tailwind css.
---
...
<PropsTable
  props={[
    { name: "placeholder", type: "string", required: false, default: "null" },
    { name: "className", type: "string", required: false, default: "null" },
