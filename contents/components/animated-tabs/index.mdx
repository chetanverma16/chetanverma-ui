---
title: Animated Tabs
description: Animated tabs interaction made with framer motion and tailwind css.
---
...
<PropsTable
  props={[
    ...
    },
    {
      name: "defaultTab",
      type: "string",
      description: "The default tab to display.",
      default: "tabs[0].id",
    },
    {
      name: "className",
      type: "string",
      description: "The className to apply to the component.",
    },
